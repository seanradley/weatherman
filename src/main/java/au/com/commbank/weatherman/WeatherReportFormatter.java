...
public class WeatherReportFormatter {
    ...
    public String format(WeatherReport weatherReport) {
        ...
        stringBuffer.append(new DecimalFormat("#0.00").format(weatherReport.getWeatherStation().getLatitude())).append(",")
                .append(new DecimalFormat("#0.00").format(weatherReport.getWeatherStation().getLongitude())).append(",")
        ...
        stringBuffer.append(new DecimalFormat("#0.0").format(weatherReport.getTemperature())).append(SEPARATOR);

        stringBuffer.append(new DecimalFormat("#0.0").format(weatherReport.getPressure())).append(SEPARATOR);
